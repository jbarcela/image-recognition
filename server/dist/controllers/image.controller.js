...
var Google = require("./../services/google-cloud");
var ImageController = /** @class */ (function () {
    function ImageController() {
        var _this = this;
        this.path = "/image";
        this.router = express.Router();
        this.extractDataFromImage = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var content;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        content = new content_model_1.Content();
                        content.image = req.file.buffer;
                        //extraindo texto da imagem utilizando o Google
                        return [4 /*yield*/, Google.process(content)];
                    case 1:
                        //extraindo texto da imagem utilizando o Google
                        _a.sent();
