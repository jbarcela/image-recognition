...
var content_model_1 = require("./../models/content.model");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    content.googleContent = new content_model_1.GoogleContent();
                    return [4 /*yield*/, extractTextFromImage(content)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, understandingText(content)];
                case 2:
                    _a.sent();
...
function extractTextFromImage(content) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.documentTextDetection(content.image)];
                case 1:
                    result = (_a.sent())[0];
...
function understandingText(content) {
    return __awaiter(this, void 0, void 0, function () {
